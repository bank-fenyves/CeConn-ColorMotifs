# -*- coding: utf-8 -*-
"""
Created on Sat Oct 18 12:28:23 2025
...
translatordf =  pd.read_csv (Path(__file__).with_name('translator2.csv'), sep=';')
...
for networkcounter in range (0, 1001):
    sampledf = pd.read_csv (Path(__file__).with_name('translator2.csv'), sep=';')
